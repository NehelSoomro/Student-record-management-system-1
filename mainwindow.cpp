...
bool MainWindow::validateFields()
{
    ...
    if (ui->lineEditName->toPlainText().trimmed().isEmpty() ||
        ui->lineEditFather->toPlainText().trimmed().isEmpty() ||
        ui->lineEditCaste->toPlainText().trimmed().isEmpty() ||
        ui->lineEditDistrict->toPlainText().trimmed().isEmpty() ||
        ui->lineEditRoll->toPlainText().trimmed().isEmpty() ||
        ui->lineEditGPA->toPlainText().trimmed().isEmpty()) {
    ...
    // Validate GPA format
    QString gpa = ui->lineEditGPA->toPlainText().trimmed();
    bool ok;
...
void MainWindow::onAddClicked() {
    ...
    QString roll = ui->lineEditRoll->toPlainText().trimmed();
    ...
    Student s;
    s.name = ui->lineEditName->toPlainText().trimmed();
    s.roll = ui->lineEditRoll->toPlainText().trimmed();
    s.father = ui->lineEditFather->toPlainText().trimmed();
    s.caste = ui->lineEditCaste->toPlainText().trimmed();
    s.district = ui->lineEditDistrict->toPlainText().trimmed();
    s.gpa = ui->lineEditGPA->toPlainText().trimmed();
...
void MainWindow::onUpdateClicked() {
    ...
    QString newRoll = ui->lineEditRoll->toPlainText().trimmed();
...
void MainWindow::on_pushButton_clicked()
{
    ...
    qDebug() << "Roll field text:" << ui->lineEditRoll_2->toPlainText();
    qDebug() << "Roll field trimmed:" << ui->lineEditRoll_2->toPlainText().trimmed();
    qDebug() << "Is roll field empty?" << ui->lineEditRoll_2->toPlainText().trimmed().isEmpty();

    // Check other fields bhi
    qDebug() << "Name field:" << ui->lineEditName->toPlainText();
    qDebug() << "Total students:" << students.size();
    ui->lineEditRoll_2->setFocus();

    // Yahan direct search ka code likhein
    QString rollToSearch = ui->lineEditRoll_2->toPlainText().trimmed();
